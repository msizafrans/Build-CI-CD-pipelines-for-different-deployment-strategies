...
echo "Fetching IAM github-action-user1 ARN"
...
./aws-iam-authenticator add user --userarn="${userarn}" --username=github-action-user1 --groups=system:masters --kubeconfig="$HOME"/.kube/config --prompt=false
